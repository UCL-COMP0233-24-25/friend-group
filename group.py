...
my_group =[{"Yitian Xu":{"age":23,"job":None,"connection":[{"Zicong Peng":"friend"}]}},[{"Zicong Peng":{"age":22,"job":None,"connection":[{"Yitian Xu":"friend"}]}}]]
example_group ={"Jill":{"age":26,"job":"biologist","connection":{"Zalika":"friend","John":"partner"}},
...
for person in example_group:
    print(f"{person} is {example_group[person]["age"]}, a {example_group[person]["job"]} ")